...
def straddle_strike(start_dt):
    while (start_dt < end_dt):
        try:           
            ...
            return ce_scrip, pe_scrip, ce_price, pe_price, start_dt, future_price, round(ce_price, -1)
        ...
        try:
            ...
            while from_date <= to_date:
                ...
                if options_multiplier <= 0:
                    ce_scrip, pe_scrip, ce_entry, pe_entry, start_dt, future_price, target = straddle_strike(start_dt)
                else:
